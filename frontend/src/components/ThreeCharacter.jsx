...
const BotAvatar = () => {
  ...
  useFrame((state) => {
    ...
    // Subtle bobbing is handled by Float, but we can add rotation or other effects here
  ...
  return (
    <group ref={group} rotation={[0, Math.PI, 0]} scale={2.2}>
      <Float speed={2} rotationIntensity={0.2} floatIntensity={0.5}>
        ...
        {/* Jetpack / Back Thruster */}
        <Cylinder args={[0.15, 0.2, 0.4, 32]} position={[0, 0, -0.25]} rotation={[0.5, 0, 0]}>
           <meshStandardMaterial color="#334155" />
        </Cylinder>

        {/* Engine Glow particle simulation (simple sphere as placeholder for trail) */}
