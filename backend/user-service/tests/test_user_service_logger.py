...
class TestUserServiceFunctionDecorator:
    ...
    def test_successful_function_call(self):
        ...
        with patch('user_service.monitoring.logger.user_service_logger.info') as mock_log:
    ...
    def test_failed_function_call(self):
        ...
        with patch('user_service.monitoring.logger.user_service_logger.info') as mock_log:
            with patch('user_service.monitoring.logger.user_service_logger.error') as mock_error:
