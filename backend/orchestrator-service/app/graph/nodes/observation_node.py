...
async def observation_node(state: AgentState):
    ...
    if tool_result["type"] == "career_question":
        updates["ws_event"] = {"type": "NAVIGATE", "target": "career"}

    # ROADMAP RESULT
    elif tool_result["type"] == "roadmap_result":
        updates["ws_event"] = {"type": "NAVIGATE", "target": "roadmap"}

    elif tool_result.get("type") == "job_results":
        updates["ws_event"] = {"type": "NAVIGATE", "target": "jobs"}
        ...
        updates["ws_event"] = {"type": "NAVIGATE", "target": "linkedin"}
    ...
    if state.get("quiz_mode") and state.get("agent_action") is None:
        ...
        updates["ws_event"] = {"type": "NAVIGATE", "target": "news"}
