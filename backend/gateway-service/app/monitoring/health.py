...
async def health_check() -> Dict[str, Any]:
    ...
    return {"status": "healthy", "timestamp": time.time(), "service": "maargha-gateway"}
...
async def test_external_services() -> Dict[str, str]:
    ...
    try:
        ...
        monitoring_logger.warning(
            "Orchestrator service health check failed", extra={"error": str(e)}
        )
...
async def liveness_check() -> Dict[str, Any]:
    ...
    return {"status": "alive", "timestamp": time.time(), "service": "maargha-gateway"}
